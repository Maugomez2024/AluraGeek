...
contactForm.addEventListener('submit', (e) => {
    ...
    if(success) {        
        text.innerText = 'Mensaje enviado correctamente!';
        ...
        text.innerText = 'Se produjo un error al enviar el mensaje. Por favor, comprueba que los campos se han rellenado correctamente.';
