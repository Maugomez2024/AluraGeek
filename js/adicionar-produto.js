...
form.addEventListener('submit', e => {
    ...
    if(success) {        
        text.innerText = 'Producto agregado exitosamente!';
        ...
        text.innerText = 'Error al guardar el producto. Por favor, comprueba que los campos se han rellenado correctamente.';
